    ...
    <section className="relative flex flex-col flex-grow justify-center items-center bg-gradient-to-br from-emerald-200 via-blue-100 to-violet-300 py-16 px-2 sm:px-6 pt-32 select-none caret-transparent min-h-screen">
      ...
      >
        ...
        <p className="text-justify text-base leading-relaxed text-gray-900  font-['PT_Serif']">
          ...
          knowledge offered by systematic research and scholarship. It is a
          registered society with the Government of Maharashtra, Assistant
          Charity Commissioner, Thane District, Maharashtra. The Society aims to
          be the leading international society in the field, as to both the
          support and the dissemination of research and higher education. We aim
          to commit to sustainable development and focus on the solutions to the
          climate change, social inequality, awareness of literature and
          language, spread of scientific attitude in academicians and citizens,
        ...
        <p className="text-justify text-base leading-relaxed text-gray-900 font-['PT_Serif']">
          ...
          is especially pronounced in the realm of higher education and research
          society because at these level students are being prepared to enter
          the skilled human resource market and emerge with skills to contribute
          to the intellectual property and they will act as harbingers of ideas.
          The sustainable development that we wish is not only an economic
          process but also an academic process. It enables the pattern of
          resources meeting the needs of the present as well as to enhance the
          ability of future generations to meet their own intellectual needs. In
          order to preserve the standard of natural world, economic, social,
          environmental and academic world, it is essential to consider and
          harmonise the intellectual factors. Formal and informal learning,
        ...
        <p className="text-justify text-base leading-relaxed text-gray-900 font-['PT_Serif']">
          ...
          management and operational systems. However, the debate still persists
          primarily on the rationale and reasoning for why sustainable
          development needs broad adoption. The international discussion,
        ...
        <p className="text-justify text-base leading-relaxed text-gray-900 font-['PT_Serif']">
          ...
          to develop visions of higher education and to optimise its
          contribution to sustainable development and also, to look at areas
